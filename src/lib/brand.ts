 ...
 *
 * Positioning is locked: AI Governance Practice is scenario training for AI
 * governance practitioners, published by NHID-Clinical. Copy must never promise exam
...
export const BRAND = {
  ...
  tagline: "Scenario training for AI governance practitioners",
  category: "AI governance scenario training built for practitioners.",
  positioning:
    "AI Governance Practice helps professionals build practical AI governance judgment through original scenario-based learning.",
...
export const DISCLAIMER_BODY = [
  "AI Governance Practice provides original educational content for professional development in AI governance.",
