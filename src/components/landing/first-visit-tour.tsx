...
const STEPS = [
  ...
  },
  {
    ...
    body: "Facts, then Obligations, then Risks, then Action. Naming a framework before the facts is the common failure.",
  },
  {
    kicker: "The loop",
    title: "Scenario → Decide → Feedback → Carry forward",
    body: "Read the facts without jumping to a framework. Choose the narrowest defensible next step. See why, including the near-miss distractors.",
  },
  {
    kicker: "Two modes",
    title: "Same bank. Different pressure.",
    body: "Study teaches the loop with immediate feedback and a review queue. Exam withholds feedback, runs a clock, and scores the sitting.",
  },
  {
    kicker: "Start",
    title: "Try one on this page",
    body: "The sample question is a real item. Nothing you do there is recorded. Help stays in the header if you need this again.",
  },
] as const;
