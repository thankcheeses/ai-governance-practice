...
The study page `contextReviewed` field is the live claim date shown to learners.
Full subdomain matrix and historical rewrites remain documented in repository
history and in the operational procedure above.
