...
Assessment and checklist for shipping AIGP Practice to the App Store and Play
...
> **AIGP Practice — AI Governance Practice for Practitioners**
>
...
| `appName` | `AIGP Practice` | Store display name |
...
Android launcher icons are the AIGP Practice shield, **not** the Capacitor
